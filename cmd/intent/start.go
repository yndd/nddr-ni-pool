...
import (
	...
	"github.com/yndd/nddr-ni-pool/internal/controllers"
	"github.com/yndd/nddr-ni-pool/internal/pool"

	//"github.com/yndd/nddr-ni-pool/internal/applogic"
...
var startCmd = &cobra.Command{
	Use:          "start",
	Short:        "start the nipool nddo intent manager",
	Long:         "start the nipool ndd0 intent manager",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		nddcopts := &shared.NddControllerOptions{
			Logger:    logging.NewLogrLogger(zlog.WithName("nipool")),
			Poll:      pollInterval,
			Namespace: namespace,
